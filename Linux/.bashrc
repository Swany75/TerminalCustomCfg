...
# Recorda que per aplicar els canvis has d'executar: source ~/.bashrc
...
### MEDIA SERVER ADMINISTRATION CUSTOM COMMANDS #################################################################################################################################

# ENTER NAS

function enterNAS() {
    cd /media/swany/6373FE293EF8339B1/PorygonCloud/
    export PS1="Cloud\${PWD#/media/swany/6373FE293EF8339B1/PorygonCloud}\$ "
}
...
# REMOVE TRASH AND MOVE EPISODES

function raremove () {

    DIR=$(pwd)
    EXT=("*.mp4" "*.mkv" "*.avi" "*.rar" "*.zip")
